...
(function (exports) {
	var KeyBoardTwo = function (input, n, options) {
		currentInput = input;
		...
		cssStr +=
			'.a-bounceinB{bottom:0;border:0;-webkit-animation:bounceinB 0.3s ease-in backwards;-moz-animation:bounceinB 0.3s ease-in backwards;-ms-animation:bounceinB 0.3s ease-in backwards;animation:bounceinB 0.3s ease-in backwards;}';
		cssStr +=
			'.a-bounceoutB{bottom:-250px;border:0;padding:0;-webkit-animation:bounceoutB 0.3s ease-out backwards;-moz-animation:bounceoutB 0.3s ease-out backwards;-ms-animation:bounceoutB 0.3s ease-out backwards;animation:bounceoutB 0.3s ease-out backwards;}';
		cssStr +=
			'@-webkit-keyframes bounceoutB{0%{opacity:1;-webkit-transform:translateY(-250px);}100%{opacity:0;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@-moz-keyframes bounceoutB{0%{opacity:1;-webkit-transform:translateY(-250px);}100%{opacity:0;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@-ms-keyframes bounceoutB{0%{opacity:1;-webkit-transform:translateY(-250px);}100%{opacity:0;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@keyframes bounceoutB{0%{opacity:1;-webkit-transform:translateY(-250px);}100%{opacity:0;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@-webkit-keyframes bounceinB{0%{opacity:0;-webkit-transform:translateY(250px);}100%{opacity:1;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@-moz-keyframes bounceinB{0%{opacity:0;-webkit-transform:translateY(250px);}100%{opacity:1;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@-ms-keyframes bounceinB{0%{opacity:0;-webkit-transform:translateY(250px);}100%{opacity:1;-webkit-transform:translateY(0);}}';
		cssStr +=
			'@keyframes bounceinB{0%{opacity:0;-webkit-transform:translateY(250px);}100%{opacity:1;-webkit-transform:translateY(0);}}';
		//table样式
		cssStr += '#' + TABLE_ID +
			'{font-size:18px;text-align:center;width:100%;height:200px;border-top:1px solid #CECDCE;background-color:#FFF;}';
		...
		btnCompleteStr +=
			'line-height:32px;font-size: 14px;border-radius:3px;margin-top:8px;;cursor:pointer;display:inline-block;">无法测量</div>';
...
//      btnCompleteStr +=
		...
		btnCompleteStr += 'float:right;margin-right:2%;text-align:center;color:#fff;';
		btnCompleteStr +=
			'line-height:32px;font-size: 14px;border-radius:3px;margin-top:8px;;cursor:pointer;display:inline-block;">完成</div>';
		//Button
		...
		//input
		var inputStr =
			'<input type="text" id="_input" value="" readonly="readonly" placeholder="" unselectable="on" onfocus="this.blur()"';
		...
		tableStr += '	<tr><td>0</td><td>H</td><td>L</td></tr>';
		tableStr += '	 <tr><td style="background-color:#D3D9DF;">重置</td>';
		tableStr += '	 	<td>.</td><td style="background-color:#D3D9DF;">删除</td></tr>';
...
//		      tableStr += '	 			<td style="background-color:#D3D9DF;">删除</td></tr>';
		...
		function addEvent(e) {
			...
			if (clickEl.tagName.toLocaleLowerCase() === 'td' && value !== "删除" && value !== "重置" && value !== "H" && value !== "L") {
				if (input) {
				...
				self.el.style.bottom = '-250px';
				document.getElementById("background").classList.add('opacityOut');
			} else if (clickEl.tagName.toLocaleLowerCase() === 'td' && value === "H") {
					_input.value = "H";
			} else if (clickEl.tagName.toLocaleLowerCase() === 'td' && value === "L") {
					_input.value = "L";
			} else if (clickEl.tagName.toLocaleLowerCase() === 'td' && value === "重置") {
	...
	exports.KeyBoardTwo = KeyBoardTwo;
...
//			var text = $("#keyboard-select option:selected").text();
//			var value = $("#keyboard-select option:selected").val();
////			div.innerHTML = text;
...
//		console.log($("#keyboard-select").innerHeight());
		document.getElementById("background").classList.add('opacityOut');
...
$('body').on('tap', '#keyboard-select', function () {
	document.getElementById("__w_l_h_v_c_z_e_r_o_divid").classList.add('opacityOut');
...
$("body").on('tap','#keyboard-qtyyBtn',function(){
	...
	if(inputVal != ""){
		document.getElementById('wfclyySelect').classList.add('opacityOut');
		document.getElementById("background").classList.add('opacityOut');
